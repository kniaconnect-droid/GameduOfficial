...
// dari query param atau apapun yang dikirim client. File worksheet asli (saat
// ini berupa gambar PNG, bukan PDF) cuma boleh ke-stream kalau user
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  // Content-Type mengikuti ekstensi file asli -- worksheet sekarang berupa
  // gambar (PNG), tapi dibuat dinamis biar tetap aman kalau suatu saat ada
  // worksheet PDF lagi.
